...
* Continue on one stage research
  -  Investigate the effect of different amount of dosage
  - Find out the optimal effluent flow
1. Sleep Early
  - sleep before 12
    - get enough rest
2. Be proactive
* explore my passion
  - try to find what I actually enjoy doing
...
plt.show()
![TemperaturevsReynoldsNumbers](/Imagess/Temp_Reynold.jpg)
```
...
Yuhao Du: Nice job! So close to finish it!
Barbara Oramah: Great job! Keep it up :)
...
Yuhao Du: code is clear!
Barbara Oramah: looks good
